...
// UnblockUser provides a mock function for the type MockUserRepository
func (_mock *MockUserRepository) UnblockUser(ctx context.Context, id int) error {
	ret := _mock.Called(ctx, id)
...
// MockUserRepository_UnblockUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UnblockUser'
type MockUserRepository_UnblockUser_Call struct {
	*mock.Call
}
...
//   - ctx
//   - id
func (_e *MockUserRepository_Expecter) UnblockUser(ctx interface{}, id interface{}) *MockUserRepository_UnblockUser_Call {
	return &MockUserRepository_UnblockUser_Call{Call: _e.mock.On("UnblockUser", ctx, id)}
}

func (_c *MockUserRepository_UnblockUser_Call) Run(run func(ctx context.Context, id int)) *MockUserRepository_UnblockUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int))
	})
	return _c
...
func (_c *MockUserRepository_UnblockUser_Call) Return(err error) *MockUserRepository_UnblockUser_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockUserRepository_UnblockUser_Call) RunAndReturn(run func(ctx context.Context, id int) error) *MockUserRepository_UnblockUser_Call {
	_c.Call.Return(run)
	return _c
}
