...
// NewMockBlockedUserService creates a new instance of MockBlockedUserService. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
// The first argument is typically a *testing.T value.
func NewMockBlockedUserService(t interface {
	mock.TestingT
	Cleanup(func())
}) *MockBlockedUserService {
	mock := &MockBlockedUserService{}
	mock.Mock.Test(t)
...
// MockBlockedUserService is an autogenerated mock type for the BlockedUserService type
type MockBlockedUserService struct {
	mock.Mock
}

type MockBlockedUserService_Expecter struct {
	mock *mock.Mock
}

func (_m *MockBlockedUserService) EXPECT() *MockBlockedUserService_Expecter {
	return &MockBlockedUserService_Expecter{mock: &_m.Mock}
}

// BlockUser provides a mock function for the type MockBlockedUserService
func (_mock *MockBlockedUserService) BlockUser(ctx context.Context, blockedUserID int, reason string, blockerID *int, blockedUntil *time.Time) error {
...
// MockBlockedUserService_BlockUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'BlockUser'
type MockBlockedUserService_BlockUser_Call struct {
	*mock.Call
}
...
//   - blockerID
//   - blockedUntil
func (_e *MockBlockedUserService_Expecter) BlockUser(ctx interface{}, blockedUserID interface{}, reason interface{}, blockerID interface{}, blockedUntil interface{}) *MockBlockedUserService_BlockUser_Call {
	return &MockBlockedUserService_BlockUser_Call{Call: _e.mock.On("BlockUser", ctx, blockedUserID, reason, blockerID, blockedUntil)}
}

func (_c *MockBlockedUserService_BlockUser_Call) Run(run func(ctx context.Context, blockedUserID int, reason string, blockerID *int, blockedUntil *time.Time)) *MockBlockedUserService_BlockUser_Call {
...
func (_c *MockBlockedUserService_BlockUser_Call) Return(err error) *MockBlockedUserService_BlockUser_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockBlockedUserService_BlockUser_Call) RunAndReturn(run func(ctx context.Context, blockedUserID int, reason string, blockerID *int, blockedUntil *time.Time) error) *MockBlockedUserService_BlockUser_Call {
	_c.Call.Return(run)
	return _c
}

// IsUserBlocked provides a mock function for the type MockBlockedUserService
func (_mock *MockBlockedUserService) IsUserBlocked(ctx context.Context, userID int) (bool, *models.BlockedUser, error) {
...
// MockBlockedUserService_IsUserBlocked_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'IsUserBlocked'
type MockBlockedUserService_IsUserBlocked_Call struct {
	*mock.Call
}
...
//   - ctx
//   - userID
func (_e *MockBlockedUserService_Expecter) IsUserBlocked(ctx interface{}, userID interface{}) *MockBlockedUserService_IsUserBlocked_Call {
	return &MockBlockedUserService_IsUserBlocked_Call{Call: _e.mock.On("IsUserBlocked", ctx, userID)}
}

func (_c *MockBlockedUserService_IsUserBlocked_Call) Run(run func(ctx context.Context, userID int)) *MockBlockedUserService_IsUserBlocked_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *MockBlockedUserService_IsUserBlocked_Call) Return(b bool, blockedUser *models.BlockedUser, err error) *MockBlockedUserService_IsUserBlocked_Call {
	_c.Call.Return(b, blockedUser, err)
	return _c
}

func (_c *MockBlockedUserService_IsUserBlocked_Call) RunAndReturn(run func(ctx context.Context, userID int) (bool, *models.BlockedUser, error)) *MockBlockedUserService_IsUserBlocked_Call {
	_c.Call.Return(run)
	return _c
}

// UnblockUser provides a mock function for the type MockBlockedUserService
func (_mock *MockBlockedUserService) UnblockUser(ctx context.Context, blockedUserID int) error {
...
// MockBlockedUserService_UnblockUser_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'UnblockUser'
type MockBlockedUserService_UnblockUser_Call struct {
	*mock.Call
}
...
//   - ctx
//   - blockedUserID
func (_e *MockBlockedUserService_Expecter) UnblockUser(ctx interface{}, blockedUserID interface{}) *MockBlockedUserService_UnblockUser_Call {
	return &MockBlockedUserService_UnblockUser_Call{Call: _e.mock.On("UnblockUser", ctx, blockedUserID)}
}

func (_c *MockBlockedUserService_UnblockUser_Call) Run(run func(ctx context.Context, blockedUserID int)) *MockBlockedUserService_UnblockUser_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(int))
	})
	return _c
...
func (_c *MockBlockedUserService_UnblockUser_Call) Return(err error) *MockBlockedUserService_UnblockUser_Call {
	_c.Call.Return(err)
	return _c
}

func (_c *MockBlockedUserService_UnblockUser_Call) RunAndReturn(run func(ctx context.Context, blockedUserID int) error) *MockBlockedUserService_UnblockUser_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_mock *MockUserService) Login(ctx context.Context, email string, password string) (*models.User, error) {
...
func (_c *MockUserService_Login_Call) Return(user *models.User, err error) *MockUserService_Login_Call {
	_c.Call.Return(user, err)
	return _c
}

func (_c *MockUserService_Login_Call) RunAndReturn(run func(ctx context.Context, email string, password string) (*models.User, error)) *MockUserService_Login_Call {
	_c.Call.Return(run)
	return _c
}
