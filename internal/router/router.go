...
func CreateRouter(config config.Config) (*gin.Engine, error) {
	...
	r.Use(cors.New(cors.Config{
		AllowOrigins: []string{"https://backoffice-three-theta.vercel.app", "http://localhost:8081", "https://backoffice-ruby-gamma.vercel.app", "https://backoffice-mu-three.vercel.app"}, // frontend address here
